<template>
  <div class="carousel">
    <div class="carousel-inner" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
      <div
        v-for="(movie, index) in slicedCarouselData"
        :key="movie.movieID"
        class="carousel-item"
    ...
    <div class="heroOverview" v-if="slicedCarouselData.length" >
      ...
      <div class="date">Released: {{ slicedCarouselData[currentIndex].movieDate }}</div>
      <div class="description">{{ slicedCarouselData[currentIndex].movieOverview }}</div>
      <button @click="goToMoviePage(slicedCarouselData[currentIndex].movieID)">Go To Movie</button>
    </div>
...
<script>
  ...
  computed: {
    slicedCarouselData() {
      return this.heroMovieCarousel.slice(0, 5);
    },
  },
